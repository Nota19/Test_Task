 ...
 * {@link ru.hmel.service.impl.ElectronicsLocalServiceImpl} and is the
 ...
 * @see ru.hmel.service.base.ElectronicsLocalServiceBaseImpl
 * @see ru.hmel.service.impl.ElectronicsLocalServiceImpl
 * @generated
 */
public class ElectronicsLocalServiceUtil {
    private static ElectronicsLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link ru.hmel.service.impl.ElectronicsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static ru.hmel.model.Electronics addElectronics(
    ...
    */
    public static ru.hmel.model.Electronics createElectronics(
        long electronics_id) {
        return getService().createElectronics(electronics_id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.hmel.model.Electronics deleteElectronics(
        long electronics_id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteElectronics(electronics_id);
    }
    ...
    */
    ...
    public static ru.hmel.model.Electronics fetchElectronics(
        long electronics_id)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchElectronics(electronics_id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.hmel.model.Electronics getElectronics(long electronics_id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getElectronics(electronics_id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.hmel.model.Electronics> getElectronicses(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.hmel.model.Electronics updateElectronics(
        ru.hmel.model.Electronics electronics)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static ElectronicsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ElectronicsLocalService.class.getName());

            if (invokableLocalService instanceof ElectronicsLocalService) {
                _service = (ElectronicsLocalService) invokableLocalService;
            } else {
                _service = new ElectronicsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ElectronicsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ElectronicsLocalService service) {
    }
}
