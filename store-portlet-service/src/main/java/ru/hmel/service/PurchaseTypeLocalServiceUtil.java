 ...
 * {@link ru.hmel.service.impl.PurchaseTypeLocalServiceImpl} and is the
...
public class PurchaseTypeLocalServiceUtil {
    private static PurchaseTypeLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link ru.hmel.service.impl.PurchaseTypeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static ru.hmel.model.PurchaseType addPurchaseType(
    ...
    */
    public static ru.hmel.model.PurchaseType createPurchaseType(
        long purchase_type_id) {
        return getService().createPurchaseType(purchase_type_id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.hmel.model.PurchaseType deletePurchaseType(
        long purchase_type_id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePurchaseType(purchase_type_id);
    }
    ...
    */
    ...
    public static ru.hmel.model.PurchaseType fetchPurchaseType(
        long purchase_type_id)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchPurchaseType(purchase_type_id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.hmel.model.PurchaseType getPurchaseType(
        long purchase_type_id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getPurchaseType(purchase_type_id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.hmel.model.PurchaseType> getPurchaseTypes(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.hmel.model.PurchaseType updatePurchaseType(
        ru.hmel.model.PurchaseType purchaseType)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static PurchaseTypeLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    PurchaseTypeLocalService.class.getName());

            if (invokableLocalService instanceof PurchaseTypeLocalService) {
                _service = (PurchaseTypeLocalService) invokableLocalService;
            } else {
                _service = new PurchaseTypeLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(PurchaseTypeLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(PurchaseTypeLocalService service) {
    }
}
