...
public class PurchaseModelImpl extends BaseModelImpl<Purchase>
    ...
    public static final String TABLE_SQL_CREATE = "create table store_Purchase (uuid_ VARCHAR(75) null,purchase_id LONG not null primary key,electro_id LONG,employee_id LONG,purchaseDate DATE null,type_ LONG)";
    ...
    public static long PURCHASE_ID_COLUMN_BITMASK = 16L;
