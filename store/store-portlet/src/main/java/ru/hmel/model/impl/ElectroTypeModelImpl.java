...
public class ElectroTypeModelImpl extends BaseModelImpl<ElectroType>
    ...
    public static final String TABLE_SQL_CREATE = "create table store_ElectroType (uuid_ VARCHAR(75) null,electro_type_id LONG not null primary key,name VARCHAR(75) null)";
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.ru.hmel.model.ElectroType"),
            true);
    public static long UUID_COLUMN_BITMASK = 1L;
    public static long ELECTRO_TYPE_ID_COLUMN_BITMASK = 2L;
    ...
    public void resetOriginalValues() {
        ElectroTypeModelImpl electroTypeModelImpl = this;

        electroTypeModelImpl._originalUuid = electroTypeModelImpl._uuid;

        electroTypeModelImpl._columnBitmask = 0;
    }
