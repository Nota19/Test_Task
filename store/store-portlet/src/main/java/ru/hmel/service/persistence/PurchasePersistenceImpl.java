...
public class PurchasePersistenceImpl extends BasePersistenceImpl<Purchase>
     ...
     */
    @Override
    public List<Purchase> findByUuid(String uuid) throws SystemException {
    ...
    public List<Purchase> findByUuid(String uuid, int start, int end,
        ...
        if ((list != null) && !list.isEmpty()) {
            for (Purchase purchase : list) {
                if (!Validator.equals(uuid, purchase.getUuid())) {
                    list = null;
     ...
     */
    @Override
    public Purchase[] findByUuid_PrevAndNext(long purchase_id, String uuid,
        OrderByComparator orderByComparator)
        throws NoSuchPurchaseException, SystemException {
    ...
    protected Purchase getByUuid_PrevAndNext(Session session,
        Purchase purchase, String uuid, OrderByComparator orderByComparator,
        boolean previous) {
        StringBundler query = null;
