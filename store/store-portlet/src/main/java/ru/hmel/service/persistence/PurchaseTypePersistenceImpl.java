...
public class PurchaseTypePersistenceImpl extends BasePersistenceImpl<PurchaseType>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(PurchaseTypeModelImpl.ENTITY_CACHE_ENABLED,
            PurchaseTypeModelImpl.FINDER_CACHE_ENABLED, PurchaseTypeImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(PurchaseTypeModelImpl.ENTITY_CACHE_ENABLED,
            PurchaseTypeModelImpl.FINDER_CACHE_ENABLED, PurchaseTypeImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
            new String[] { String.class.getName() },
            PurchaseTypeModelImpl.UUID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(PurchaseTypeModelImpl.ENTITY_CACHE_ENABLED,
            PurchaseTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
            new String[] { String.class.getName() });
    private static final String _FINDER_COLUMN_UUID_UUID_1 = "purchaseType.uuid IS NULL";
    private static final String _FINDER_COLUMN_UUID_UUID_2 = "purchaseType.uuid = ?";
    private static final String _FINDER_COLUMN_UUID_UUID_3 = "(purchaseType.uuid IS NULL OR purchaseType.uuid = '')";
    private static final String _SQL_SELECT_PURCHASETYPE = "SELECT purchaseType FROM PurchaseType purchaseType";
    private static final String _SQL_SELECT_PURCHASETYPE_WHERE = "SELECT purchaseType FROM PurchaseType purchaseType WHERE ";
    private static final String _SQL_COUNT_PURCHASETYPE = "SELECT COUNT(purchaseType) FROM PurchaseType purchaseType";
    private static final String _SQL_COUNT_PURCHASETYPE_WHERE = "SELECT COUNT(purchaseType) FROM PurchaseType purchaseType WHERE ";
    ...
    private static final String _NO_SUCH_ENTITY_WITH_KEY = "No PurchaseType exists with the key {";
     ...
     */
    @Override
    public List<PurchaseType> findByUuid(String uuid) throws SystemException {
    ...
    public List<PurchaseType> findByUuid(String uuid, int start, int end,
        ...
        if ((list != null) && !list.isEmpty()) {
            for (PurchaseType purchaseType : list) {
                if (!Validator.equals(uuid, purchaseType.getUuid())) {
                    list = null;
        ...
        if (list == null) {
            ...
            query.append(_SQL_SELECT_PURCHASETYPE_WHERE);
            ...
            if (orderByComparator != null) {
             ...
             if (pagination) {
                query.append(PurchaseTypeModelImpl.ORDER_BY_JPQL);
            }
     ...
     */
    @Override
    public PurchaseType findByUuid_First(String uuid,
        ...
        throw new NoSuchPurchaseTypeException(msg.toString());
    }
     ...
     */
    @Override
    public PurchaseType fetchByUuid_First(String uuid,
        OrderByComparator orderByComparator) throws SystemException {
     ...
     */
    @Override
    public PurchaseType findByUuid_Last(String uuid,
        OrderByComparator orderByComparator)
        throws NoSuchPurchaseTypeException, SystemException {
     ...
     */
    @Override
    public PurchaseType fetchByUuid_Last(String uuid,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<PurchaseType> list = findByUuid(uuid, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public PurchaseType[] findByUuid_PrevAndNext(long purchase_type_id,
        String uuid, OrderByComparator orderByComparator)
        throws NoSuchPurchaseTypeException, SystemException {
        PurchaseType purchaseType = findByPrimaryKey(purchase_type_id);
        ...
        try {
            ...
            array[0] = getByUuid_PrevAndNext(session, purchaseType, uuid,
                    orderByComparator, true);

            array[1] = purchaseType;

            array[2] = getByUuid_PrevAndNext(session, purchaseType, uuid,
    ...
    protected PurchaseType getByUuid_PrevAndNext(Session session,
        PurchaseType purchaseType, String uuid,
        ...
        if (orderByComparator != null) {
            Object[] values = orderByComparator.getOrderByConditionValues(purchaseType);
    ...
    public void removeByUuid(String uuid) throws SystemException {
        for (PurchaseType purchaseType : findByUuid(uuid, QueryUtil.ALL_POS,
    ...
    public int countByUuid(String uuid) throws SystemException {
        ...
        if (count == null) {
            ...
            query.append(_SQL_COUNT_PURCHASETYPE_WHERE);
    ...
    public PurchaseType updateImpl(ru.hmel.model.PurchaseType purchaseType)
        ...
        PurchaseTypeModelImpl purchaseTypeModelImpl = (PurchaseTypeModelImpl) purchaseType;
        ...
        if (isNew || !PurchaseTypeModelImpl.COLUMN_BITMASK_ENABLED) {
            FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
        }
        else {
            if ((purchaseTypeModelImpl.getColumnBitmask() &
                    FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID.getColumnBitmask()) != 0) {
                Object[] args = new Object[] {
                        purchaseTypeModelImpl.getOriginalUuid()
                    };
                ...
                args = new Object[] { purchaseTypeModelImpl.getUuid() };
    ...
    protected PurchaseType toUnwrappedModel(PurchaseType purchaseType) {
        ...
        purchaseTypeImpl.setUuid(purchaseType.getUuid());
